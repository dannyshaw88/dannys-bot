  ...
  async function handleExport() {
    ...
    const payload = {
      ...
      _fieldNotes: {
        ...
        leakSnapshot: "The last leak-check result set captured automatically when the embedded browser opened the Aura Farming Leak Test page for this account. Contains capturedAt timestamp, per-test pass/fail/warn/info results (IP, DNS, WebRTC, UA match, bot detection, etc.), proxy details, and user-agent strings active at the time of the test. null means no leak test has ever been run for this account.",
      },
