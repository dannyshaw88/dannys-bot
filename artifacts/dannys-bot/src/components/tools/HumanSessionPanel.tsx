...
import {
  RefreshCw, Settings, PlaySquare, BookOpen,
  MessageSquare, Repeat2, Clock, ExternalLink, Image as ImageIcon,
  ChevronDown, ChevronUp, Heart, Copy, FolderOpen, UserPlus, UserMinus, Zap, Film, Percent, AlignLeft, Trash2, Compass, Music, Hash,
} from "lucide-react";
...
import { HumanSessionFeedSection } from "@/components/tools/human-session/HumanSessionFeedSection";
  ...
  return (
    <div className="space-y-4 animate-in fade-in duration-300">
      ...
      <div className="mt-[25px]">
        <div className="border border-border rounded-xl overflow-hidden">
          ...
          <div className="divide-y divide-border">
            ...
            <HumanSessionFeedSection settings={settings} setSettings={setSettings} pctInputs={pctInputs} />
      ...
      <HumanSessionWebBrowsingSection
        ...
        webBrowsingTab={webBrowsingTab}
        setWebBrowsingTab={setWebBrowsingTab}
        cbActivity={cbActivity}
        handleSplitWebsites={handleSplitWebsites}
      />
