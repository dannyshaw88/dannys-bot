...
**How to apply:** For any device-side web camera or browser surface, prepare Chrome and handle known onboarding labels before issuing the final URL intent. Never tap arbitrary page content as a workaround.