            ...
            <div className="bg-card border border-border rounded-xl divide-y divide-border flex flex-col">
              <AppSlotRow
                ...
                row2={<>
                 ...
                 row3={
                   <div className="basis-full w-full flex flex-wrap items-start justify-start gap-x-8 gap-y-3 pt-2 [&>*:first-child]:translate-x-[5px] [&>*:nth-child(2)]:-translate-x-[10px]">
