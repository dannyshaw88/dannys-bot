...
export const TRUST_SCORE_SLOT_OWNED_FIELDS = new Set([
  ...
  "makePostEnabled",
  "makePostActivatePctMin",
  "makePostActivatePctMax",
  "makePostPerSessionMin",
  "makePostPerSessionMax",
  ...
  "makePostUseChatGpt",
  "makePostCaptionText",
  "makePostPostToProfilePctMin",
  "makePostPostToProfilePctMax",
  "makePostPostToStoryPctMin",
...
export const COPY_SECTIONS: CopySection[] = [
  ...
  { key: 'feed',          label: 'View Feed', sub: [
    ...
    { key: 'feedRerunChance',   label: 'Re-run Chance %',                fields: ['feedRerunChanceMin','feedRerunChanceMax'] },
  ]},
  ...
  { key: 'randomJitter',  label: 'Random Actions', sub: [
    ...
    { key: 'jitterUpdateBio',        label: 'Update Bio',              fields: ['updateBioActivatePctMin','updateBioActivatePctMax'] },
    { key: 'trustScoreUpdateBioDisableAfterUsed', label: 'Update Bio — Disable After Used', fields: ['updateBioDisableAfterUsed'] },
