  ...
  return (
    <>
      ...
      <div className="flex gap-3" style={{ height: "calc(100vh - 210px)" }}>
        ...
        {/* ── Right: Browser panel ── */}
        <div className="flex-1 min-w-0 flex flex-col bg-muted/10 rounded-lg border border-border overflow-hidden">
          {!isOpen ? (
            <div className="flex flex-col items-center justify-center gap-4 text-center p-8 w-full h-full">
              ...
              <div className="space-y-1.5 max-w-xs">
                ...
                <p className="text-sm text-muted-foreground">
                  Fill in your account details, then click <span className="font-medium">Create Account</span> to launch the browser.
                </p>
              </div>
            </div>
          ) : (
