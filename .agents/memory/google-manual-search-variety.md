...
Manual Google searches should use a random 2–5 word length; one-word searches are not allowed, and selected queries should be natural phrases or questions.
