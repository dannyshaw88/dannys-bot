  ...
  const HUMAN_COPY_GROUPS: CopyOptionGroup[] = [
    ...
    { label: "Follow Tool Settings", options: [
      ...
      { key: "hs_followInjection", label: "Injection Settings", description: "API calls injected between follows to simulate natural behaviour", subOptions: [
        ...
        { key: "hf_injectProfileBrowsing", label: "Inject Profile Browsing", settingKeys: ["follow:injectProfileBrowsingEnabled","follow:injectProfileBrowsingMin","follow:injectProfileBrowsingMax","follow:injectProfileBrowsingFeedMin","follow:injectProfileBrowsingFeedMax","follow:injectProfileBrowsingFeedOrderMin","follow:injectProfileBrowsingFeedOrderMax","follow:injectProfileBrowsingPostPctMin","follow:injectProfileBrowsingPostPctMax","follow:injectProfileBrowsingLikePctMin","follow:injectProfileBrowsingLikePctMax","follow:injectProfileBrowsingLikePctOrderMin","follow:injectProfileBrowsingLikePctOrderMax","follow:injectProfileBrowsingSaveMediaPctMin","follow:injectProfileBrowsingSaveMediaPctMax","follow:injectProfileBrowsingSaveMediaPctOrderMin","follow:injectProfileBrowsingSaveMediaPctOrderMax","follow:injectProfileBrowsingWatchStoriesPctMin","follow:injectProfileBrowsingWatchStoriesPctMax","follow:injectProfileBrowsingWatchStoriesPctOrderMin","follow:injectProfileBrowsingWatchStoriesPctOrderMax","follow:injectProfileBrowsingViewHighlightsPctMin","follow:injectProfileBrowsingViewHighlightsPctMax","follow:injectProfileBrowsingViewHighlightsPctOrderMin","follow:injectProfileBrowsingViewHighlightsPctOrderMax","follow:injectProfileBrowsingViewReelsPctMin","follow:injectProfileBrowsingViewReelsPctMax","follow:injectProfileBrowsingViewReelsPctOrderMin","follow:injectProfileBrowsingViewReelsPctOrderMax","follow:injectProfileBrowsingCommentEnabled","follow:injectProfileBrowsingCommentPctMin","follow:injectProfileBrowsingCommentPctMax","follow:injectProfileBrowsingCommentPctOrderMin","follow:injectProfileBrowsingCommentPctOrderMax","follow:injectProfileBrowsingCommentText","follow:injectProfileBrowsingShareToDmPctMin","follow:injectProfileBrowsingShareToDmPctMax","follow:injectProfileBrowsingShareToDmPctOrderMin","follow:injectProfileBrowsingShareToDmPctOrderMax","follow:injectProfileBrowsingAbandonFollow","follow:injectProfileBrowsingAbandonFollowPctMin","follow:injectProfileBrowsingAbandonFollowPctMax","follow:injectProfileBrowsingAbandonFollowOrderMin","follow:injectProfileBrowsingAbandonFollowOrderMax"] },
      ]},
    ...
    <div className="space-y-4 animate-in fade-in duration-300">
      ...
      <div className="mt-[25px]">
        <div className="border border-border rounded-xl overflow-hidden">
          <div className="flex items-center gap-2 px-4 py-3 bg-cyan-500 border-b border-cyan-400 max-w-[37.5%]">
