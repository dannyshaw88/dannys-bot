          ...
          <div className="w-full lg:w-80 shrink-0 border-b lg:border-b-0 lg:border-r border-border/60 bg-muted/10 flex flex-col z-10">
            <div className="p-5 border-b border-border/60 bg-background/50">
              ...
              <p className="text-[13px] text-muted-foreground mt-1.5 leading-relaxed">
                Batch process local images before manually posting outside the software.
              </p>
            </div>
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="space-y-1 mt-0.5">
                      ...
                      <p className="text-[12px] text-muted-foreground leading-snug pr-4">
                        Remove unnatural smoothing and standardize image features.
                      </p>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start justify-between gap-3">
                      <div className="space-y-1 mt-0.5">
                        ...
                        <p className="text-[12px] text-muted-foreground leading-snug pr-4">
                          Subtle modifications to bypass exact-match hash detection.
                        </p>
                      </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start justify-between gap-3">
                      <div className="space-y-1 mt-0.5">
                        ...
                        <p className="text-[12px] text-muted-foreground leading-snug pr-4">
                          Randomized post-processing filters applied per image.
                        </p>
                      </div>
                 ...
                 <div className="h-full flex items-center justify-center min-h-[300px]">
                   <div className="flex flex-col items-center max-w-[320px] text-center animate-in fade-in zoom-in-95 duration-300">
                     ...
                     <p className="text-[13px] text-muted-foreground mb-6 leading-relaxed">
                       Import local images to prepare them for posting. They will be processed through the exact same pipeline used by the human session tool.
                     </p>
                     <Button 
                       variant="outline" 
                        onClick={browseForFiles}
