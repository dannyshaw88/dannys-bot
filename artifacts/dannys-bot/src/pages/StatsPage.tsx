...
const FARM_STAT_LABELS: { key: string; label: string; icon: React.ReactNode; color: string; showEye?: boolean }[] = [
  ...
  { key: "saves",           label: "Saves",           icon: <Bookmark className="w-3 h-3" />,   color: "text-black" },
...
const MOBILE_METRIC_DEFS: {
  ...
  { key: "saves",            label: "Saves",           icon: <Bookmark className="w-3.5 h-3.5" />, color: "text-black",      pieColor: "#000000" },
