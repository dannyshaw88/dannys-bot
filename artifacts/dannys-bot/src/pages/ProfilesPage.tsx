...
const STATUS_META: Record<AccountStatus, {
  ...
  suspended:            { label: "Confirm Human",         icon: ScanFace,    pill: "bg-amber-50  text-amber-700  border-amber-200"  },
  confirm_human:        { label: "Confirm Human",         icon: ScanFace,    pill: "bg-amber-50  text-amber-700  border-amber-200"  },
