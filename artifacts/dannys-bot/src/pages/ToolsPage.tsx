...
import {
  ...
  ChevronLeft, Home, Power, Keyboard, ImagePlus, Wifi,
  Search, Bell, Heart, MessageCircle, UserCircle, MoreHorizontal, Camera,
} from "lucide-react";
...
/**
 * Visual-only phone mirror for the Trust Scores settings surface.
 * This intentionally has no device props, event handlers, or API calls. It
 * mirrors the Phone Farm shell so the settings page can be previewed in the
 * same layout as an attached device without waking or touching a phone.
 */
function FakeTrustScoreMirror() {
  return (
    <div className="lg:sticky lg:top-4 self-start w-full max-w-[340px] mx-auto">
      <div className="mb-2 flex items-center justify-between px-1">
        <div>
          ...
          <p className="text-[10px] text-muted-foreground">Preview only · not connected</p>
        </div>
      ...
      >
        {/* Same device header chrome as Phone Farm's PhoneSlot. */}
        ...
        {/* Screen ratio is applied to the screen only, not the header/nav. */}
        ...
        {/* Same bottom device controls as Phone Farm, rendered as inert chrome. */}
