...
For incident analysis, successful `adb shell input tap` completion proves only that ADB accepted and dispatched the coordinate. Without a contemporaneous foreground-window/UI dump or screenshot, a bottom-edge coordinate cannot be proven to have hit Instagram rather than Android system navigation.
